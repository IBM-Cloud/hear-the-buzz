...
class InterfaceController: WKInterfaceController {
    ...
    override func contextForSegueWithIdentifier(segueIdentifier: String) ->
        ...
        if segueIdentifier == "positive" {
            return ["segue": "positive", "data":"Positive"]
        } else if segueIdentifier == "negative" {
            return ["segue": "negative", "data": "Negative"]
        } else {
            return ["segue": "", "data": "Positive"]
        }
    }
}